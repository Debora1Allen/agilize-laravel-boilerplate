 ...
 */
final class Version20221017201402 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE resposta-prova (id UUID NOT NULL, questao_id UUID DEFAULT NULL, alternativa VARCHAR(255) NOT NULL, is_correta BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
