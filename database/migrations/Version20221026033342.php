 ...
 */
final class Version20221026033342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE questoes_prova RENAME COLUMN pergunta TO texto');
        ...
        $this->addSql('ALTER TABLE repostas RENAME COLUMN alternativa TO resposta');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repostas RENAME COLUMN resposta TO alternativa');
        $this->addSql('ALTER TABLE questoes_prova DROP CONSTRAINT FK_2AA5F52E272FAB5F');
        $this->addSql('ALTER TABLE questoes_prova RENAME COLUMN texto TO pergunta');
        $this->addSql('ALTER TABLE questoes DROP CONSTRAINT fk_2b93b1afa64a8a17');
